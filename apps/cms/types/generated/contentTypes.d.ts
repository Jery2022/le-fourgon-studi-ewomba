...
export interface ApiArticleTagArticleTag extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tags pour le blog';
    displayName: 'Tag Article';
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contenu \u00E9ditorial du blog Le Fourgon';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiCollectionPointCollectionPoint
  extends Struct.CollectionTypeSchema {
  collectionName: 'collection_points';
  info: {
    description: 'Points de collecte et retrait des consignes';
    displayName: 'Point de Collecte';
    pluralName: 'collection-points';
    singularName: 'collection-point';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    openingHours: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiDeliveryZoneDeliveryZone
  ...
  info: {
    description: 'Zones de livraison avec tarifs et seuils';
    displayName: 'Zone de Livraison';
  ...
  attributes: {
    ...
    postalCodes: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Commandes clients Le Fourgon';
  ...
  attributes: {
    collectionPoint: Schema.Attribute.Relation<
      'manyToOne',
      'api::collection-point.collection-point'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    deliveryFee: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    deliverySlot: Schema.Attribute.String;
    ...
    promoDiscount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    total: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    totalDeposit: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages du site vitrine';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Cat\u00E9gories du catalogue (Bi\u00E8res, Jus, Eaux, Sodas...)';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Catalogue de boissons consign\u00E9es Le Fourgon';
    displayName: 'Produit';
    pluralName: 'products';
  ...
  attributes: {
    ...
    isAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    isBio: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    unit: Schema.Attribute.Enumeration<['bouteille', 'pack', 'caisse']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'bouteille'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPromoCodePromoCode extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Codes promotionnels et parrainage';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'T\u00E9moignages clients BtoC et BtoB';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isBtoB: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::collection-point.collection-point': ApiCollectionPointCollectionPoint;
